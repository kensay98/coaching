# Coaching Service Descriptions

---

## Table of Contents

1. [Master Service Description](#master-service-description) - The complete source document
2. [Startup Founders Version](#startup-founders-version) - For founders at 5-100 people
3. [Ambitious Professionals Version](#ambitious-professionals-version) - Broad positioning for growth-oriented professionals
4. [Key Messaging Blocks](#key-messaging-blocks) - Modular content for different uses
...
72% of founders face mental health challenges. Only 7% get support.

You're not looking for therapy. You're not broken. But you know what it's like to:

- Have a critical decision sitting in your head for weeks because you can't think through it clearly—and there's no one to discuss it with as equals
- Lose your third key hire to the same dynamic and realize the pattern is you
- Get feedback that you're micromanaging, knowing they're right but not knowing how to change it
- Lie awake wondering if you can actually handle what's coming—the Series B, the scaling, the leadership the company needs
- Start telling someone what you're really going through... and stop mid-sentence because they don't get it

You have a team, investors, maybe a co-founder, maybe a partner. And you're completely alone with the hard stuff.

---

### What You Get

**A thinking partner who understands startup context—with zero stake in your decisions.**

**Structured thinking when chaos hits.**
Fire the co-founder? Pivot or persevere? Take the term sheet on bad terms? The decision you've been procrastinating for three weeks? We turn chaos into clear problems, surface your blind spots, and help you make decisions you can actually own—not advice-driven choices you'll second-guess tomorrow.

**Patterns changed—without years of therapy.**
Lost your third key hire to the same dynamic? Micromanaging when you know you shouldn't? Avoiding the conflict that's killing momentum? We see the pattern, understand what it's protecting, and find a new way. Practical transformation, not treatment.

**A space to be honest when you can't be anywhere else.**
"I'm afraid I won't handle the Series B." "I'm not sure I deserve this valuation." "I can't stop beating myself up when things go wrong." The things you can't tell team, board, investors, or partner. Said, heard, not used against you.
...
**What You'll Feel:**
- **Worthy of your success** — not "I got lucky" but "I earned this"
- **Calm in uncertainty** — decisions made clearly, not after weeks of agonizing
- **Free to be yourself** — not performing "strong CEO" 24/7
- **Not alone** — someone knows who you really are, completely

**What Changes (Measurably):**
- **Decision quality** — faster choices, owned fully, minimal regret
- **Team retention** — patterns that caused turnover? Changed.
- **You're not the bottleneck** — company scales, you evolve with it
- **Leadership presence** — 360 feedback improves, team trust increases
...
You're not looking for therapy. You're not broken. But you know there's work to do—on who you're becoming, not just what you're accomplishing.
...
**Patterns understood and changed.**
That recurring conflict with authority. The way you shut down under stress. The tendency to over-function when you should delegate. We see the pattern, understand what it's protecting, and find a new way.

**Inner blocks worked through.**
Imposter syndrome. Self-doubt. The voice that says you're not ready. These aren't weaknesses to overcome—they're parts of you that need to be understood. When we work with them, not against them, something shifts.

**The space to be honest.**
With me, you can say the things you can't say elsewhere. The fears. The doubts. The questions that would undermine you if spoken aloud. Said, heard, held—without judgment or agenda.
...
**For yourself:**
- Confidence that comes from inside, not from external validation
- Calm in uncertainty—the capacity to lead through complexity without being consumed by it
- Freedom from old patterns that have been running you
- Peace with the parts of yourself you've been fighting
- Not being alone with the hard stuff

**For your leadership:**
- Clearer decisions, made faster, owned fully
- Better relationships—less conflict, more trust, easier communication
- Teams that follow you because of who you are, not just your title
- The capacity to grow as your scope grows, without burning out
...
**vs. Going It Alone**
You've probably been trying. How's it going? The patterns you can see but can't change exist for a reason. Sometimes you need someone outside your own system to help you shift.
...
*Modular content for different contexts—social media, emails, website sections, etc.*
...
**For founders:**
- "A thinking partner for the decisions you can't discuss with anyone else."
- "Patterns changed, decisions owned, loneliness ended—without years of therapy."
- "72% of founders face mental health challenges. Only 7% get support. You don't need therapy—you need evolution."
...
**Decision Clarity**
Turn chaos into clear problems. See your blind spots. Make decisions you can own—not advice you'll second-guess tomorrow.

**Pattern Transformation**
The behaviors that keep costing you people, opportunities, and peace of mind? We understand why they exist and change them—in months, not years.

**Safe Space**
The things you can't tell team, board, investors, or partner. Said, heard, held—with complete confidentiality and zero judgment.
...
The higher you go, the fewer people you can be honest with. Having a thinking partner isn't weakness—it's the structure that lets you operate at the next level. Every elite athlete, every top CEO has a coach. Not because they're weak—because performance at this level requires it.
...
**Softer/Curious:**
A free conversation to explore whether this could help. No commitment. Just see what it's like.
